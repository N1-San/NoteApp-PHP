            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="/" class=" <?= uriIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md hover:bg-gray-700 px-3 py-2 text-sm
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <?php if ($_SESSION['user'] ?? false): ?>
                        <div>
                            <a href="/logout"
                                class=" <?= uriIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md hover:bg-gray-700 px-3 py-2 text-sm font-medium"
